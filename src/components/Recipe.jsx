...
const dishes = [
  ...
  },
  {
    ...
    instructions: [
      `Season salmon filet with olive oil, salt, pepper, Italian seasoning, and lemon juice. Bake in a pre-heated oven at 425°F for 25 minutes.`,
      `Cook penne pasta until desired tenderness and set aside.`,
      `In a large saucepan, heat olive oil and sauté chopped garlic for 1 minute.`,
      `Add tomatoes (chopped to desired size) and heat gently, avoiding over-liquefying.`,
      `Flake cooked salmon into small pieces and add to tomatoes along with penne, butter, and basil.`,
      `Optional: Stir in heavy cream before adding basil and simmer for 1 minute. Top with grated parmesan.`,
    ],
    prepTime: '10 minutes',
    cookTime: '30 minutes',
    ...
    return (
      <div className="recipe-container p-10 border border-[#262522] rounded-2xl bg-[#FEF9F5] w-[96%] min-h-screen mx-auto flex flex-col justify-center">
        ...
        <div className="recipe-header text-center mb-2.5">
          ...
          <div className="recipe text-[0.8rem] bg-[#f85c5c] border-none rounded-2xl inline-block text-[#f2f2f2] px-2.5 py-1.25">RECIPES</div>
        ...
        <div className="recipe-details flex justify-between px-12 py-2.5 w-fit mx-auto mb-2.5">
        ...
        <div className="back-button text-center mt-5">
          <Link to="/">
            <button className="custom-button bg-[#f8b400] border-[#f8b400] text-black py-2.5 px-5 text-lg hover:text-black hover:border-black hover:bg-[#d7efd3]">Back to Menu</button>
          </Link>
        </div>
      </div>
    );
